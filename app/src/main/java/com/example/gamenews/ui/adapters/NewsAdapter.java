package com.example.gamenews.ui.adapters;
...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.binding.tvDescription.setText(news.deck);
        Picasso.get().load(news.image).fit().into(holder.binding.ivThumbnail);

        holder.binding.btOpenLink.setOnClickListener(view -> {
            Intent i = new Intent(Intent.ACTION_VIEW);
            i.setData(Uri.parse(news.site_detail_url));
        ...
        holder.binding.ivShare.setOnClickListener(view -> {
            ...
            i.putExtra(Intent.EXTRA_TEXT, news.site_detail_url);
